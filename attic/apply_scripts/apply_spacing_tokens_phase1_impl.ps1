...
'@
Set-Content .\scripts\refactors\apply_spacing_tokens_phase1_impl.py $patch -Encoding UTF8
.\.venv\Scripts\python.exe .\scripts\refactors\apply_spacing_tokens_phase1_impl.py
