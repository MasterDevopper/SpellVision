    ...
    : QWidget(parent)
{
    ...
    connect(dashboardPage_, &HomeDashboardPage::openOutputRequested, this, &HomePage::openOutputRequested);
    connect(dashboardPage_, &HomeDashboardPage::sendOutputToInputRequested, this, &HomePage::sendOutputToInputRequested);
