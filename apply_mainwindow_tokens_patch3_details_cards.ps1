...
'@
Set-Content .\scripts\refactors\apply_mainwindow_tokens_patch3_details_cards.py $patch -Encoding UTF8
.\.venv\Scripts\python.exe .\scripts\refactors\apply_mainwindow_tokens_patch3_details_cards.py
