...
'@
Set-Content .\scripts\refactors\apply_spacing_tokens_phase2_patch4_preview_transport.py $patch -Encoding UTF8
.\.venv\Scripts\python.exe .\scripts\refactors\apply_spacing_tokens_phase2_patch4_preview_transport.py
