...
'@
Set-Content .\scripts\refactors\apply_spacing_tokens_phase2_patch2_intercard_root.py $patch -Encoding UTF8
.\.venv\Scripts\python.exe .\scripts\refactors\apply_spacing_tokens_phase2_patch2_intercard_root.py
