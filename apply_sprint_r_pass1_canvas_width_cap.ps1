...
'@
Set-Content .\scripts\refactors\apply_sprint_r_pass1_canvas_width_cap.py $patch -Encoding UTF8
.\.venv\Scripts\python.exe .\scripts\refactors\apply_sprint_r_pass1_canvas_width_cap.py
