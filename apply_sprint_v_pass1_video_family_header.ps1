...
'@
Set-Content .\scripts\refactors\apply_sprint_v_pass1_video_family_header.py $patch -Encoding UTF8
.\.venv\Scripts\python.exe .\scripts\refactors\apply_sprint_v_pass1_video_family_header.py
