...
'@
Set-Content .\scripts\refactors\apply_sprint_v_pass3_family_aware_components.py $patch -Encoding UTF8
.\.venv\Scripts\python.exe .\scripts\refactors\apply_sprint_v_pass3_family_aware_components.py
