...
'@
Set-Content .\scripts\refactors\apply_mainwindow_tokens_patch1_shell_rail.py $patch -Encoding UTF8
.\.venv\Scripts\python.exe .\scripts\refactors\apply_mainwindow_tokens_patch1_shell_rail.py
