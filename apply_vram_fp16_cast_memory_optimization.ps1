...
'@
Set-Content .\scripts\refactors\apply_vram_fp16_cast_memory_optimization.py $patch -Encoding UTF8
.\.venv\Scripts\python.exe .\scripts\refactors\apply_vram_fp16_cast_memory_optimization.py
